...
#TODO make work for AB and PKR data
...
for n_clusters in range_n_clusters:
    ...
    clusterer = GaussianMixture(n_components=n_clusters,n_init=10,tol=1e-3,max_iter=1000)
    ...
    ax1.set_title(title +" Cluster Record Density")
    ...
    #TODO evaluate labels
    # 2nd Plot showing the actual clusters formed
    # colors = cm.nipy_spectral(cluster_labels.astype(float) / n_clusters)
    # #TODO X is no longer what it was
    ...
    plt.tight_layout()
    plt.savefig(title +'_'+str(n_clusters)+'_em_sil_plot.png')
    plt.close()
    # plt.show()
# plt.show()
marker = 1
...
X.to_csv('em_'+title+'_clstrdata.csv')